...
import kr.modernworld.modernworldv2.user.domain.like.port.LikeRepository;
import kr.modernworld.modernworldv2.user.infrastructure.mapper.LikeMapper;
...
public class LikeRepositoryImpl implements LikeRepository {
  ...
  public void delete(Like like) {
    likeJPARepository.delete(likeMapper.toEntity(like));
  }
